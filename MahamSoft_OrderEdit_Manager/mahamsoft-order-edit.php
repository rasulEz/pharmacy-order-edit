...
final class Mahamsoft_Order_Edit_Manager
{
                ...
                <table class="form-table" role="presentation">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <select multiple id="mahamsoft_editable_statuses" name="<?php echo esc_attr(self::OPTION_KEY); ?>[editable_statuses][]" style="min-height: 180px; min-width: 320px;">
                                    <?php foreach ($all_statuses as $status_key => $status_label):
                                        $status_slug = str_replace('wc-', '', $status_key);
                                        ?>
                                        <option value="<?php echo esc_attr($status_slug); ?>" <?php echo in_array($status_slug, (array) $settings['editable_statuses'], true) ? 'selected="selected"' : ''; ?>>
                        ...
                        <tr>
                            ...
                            <td>
                                <select multiple id="mahamsoft_restockable_statuses" name="<?php echo esc_attr(self::OPTION_KEY); ?>[restockable_statuses][]" style="min-height: 180px; min-width: 320px;">
                                    <?php foreach ($all_statuses as $status_key => $status_label):
                                        $status_slug = str_replace('wc-', '', $status_key);
                                        ?>
                                        <option value="<?php echo esc_attr($status_slug); ?>" <?php echo in_array($status_slug, (array) $settings['restockable_statuses'], true) ? 'selected="selected"' : ''; ?>>
                                            <?php echo esc_html($status_label); ?>
                                        </option>
                                    <?php endforeach; ?>
                                </select>
                        ...
                        <tr>
                            ...
                            <td>
                                <select multiple id="mahamsoft_allowed_users" name="<?php echo esc_attr(self::OPTION_KEY); ?>[allowed_users][]" style="min-height: 220px; min-width: 320px;">
                                    <?php foreach ($eligible_users as $u): ?>
                                        <option value="<?php echo esc_attr($u->ID); ?>" <?php echo in_array((int) $u->ID, (array) $settings['allowed_users'], true) ? 'selected="selected"' : ''; ?>>
                        ...
                        <tr>
                            ...
                            <td>
                                <select multiple id="mahamsoft_new_order_log_scope" name="<?php echo esc_attr(self::OPTION_KEY); ?>[new_order_log_scope][]" style="min-height: 80px; min-width: 320px;">
                                    <?php
                                    ...
                                    foreach ($new_order_log_scope_options as $opt_key => $opt_label):
                                        ?>
                                        <option value="<?php echo esc_attr($opt_key); ?>" <?php echo in_array($opt_key, (array) $settings['new_order_log_scope'], true) ? 'selected="selected"' : ''; ?>>
                        ...
                        <tr>
                            ...
                            <td>
                                <select multiple id="mahamsoft_log_phase_filter" name="<?php echo esc_attr(self::OPTION_KEY); ?>[log_phase_filter][]" style="min-height: 80px; min-width: 320px;">
                                    <?php
                                    ...
                                    foreach ($log_phase_filter_options as $opt_key => $opt_label):
                                        ?>
                                        <option value="<?php echo esc_attr($opt_key); ?>" <?php echo in_array($opt_key, (array) $settings['log_phase_filter'], true) ? 'selected="selected"' : ''; ?>>
                                            <?php echo esc_html($opt_label); ?>
                                        </option>
                                    <?php endforeach; ?>
                                </select>
                ...
                <table class="form-table" role="presentation">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" id="mahamsoft_warehouse_name" name="<?php echo esc_attr(self::OPTION_KEY); ?>[warehouse_name]" value="<?php echo esc_attr($settings['warehouse_name']); ?>" style="min-width: 320px;">
                                <p class="description">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" id="mahamsoft_api_base_url" name="<?php echo esc_attr(self::OPTION_KEY); ?>[api_base_url]" value="<?php echo esc_attr($settings['api_base_url']); ?>" style="min-width: 400px;" placeholder="https://example.com">
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" id="mahamsoft_api_key" name="<?php echo esc_attr(self::OPTION_KEY); ?>[api_key]" value="<?php echo esc_attr($settings['api_key']); ?>" style="min-width: 320px;">
                            </td>
                        </tr>
                            ...
                            <td>
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="<?php echo esc_attr(self::OPTION_KEY); ?>[api_server_name]" value="<?php echo esc_attr($settings['api_server_name']); ?>" style="min-width: 200px;">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><label><?php esc_html_e('username:', 'mahamsoft-order-edit'); ?></label></td>
                                        <td>
                                            <input type="text" name="<?php echo esc_attr(self::OPTION_KEY); ?>[api_username]" value="<?php echo esc_attr($settings['api_username']); ?>" style="min-width: 200px;">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><label><?php esc_html_e('password:', 'mahamsoft-order-edit'); ?></label></td>
                                        <td>
                                            <input type="password" name="<?php echo esc_attr(self::OPTION_KEY); ?>[api_password]" value="<?php echo esc_attr($settings['api_password']); ?>" style="min-width: 200px;">
                                        </td>
                                    </tr>
                                </table>
                            </td>
                            ...
                            <td>
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="<?php echo esc_attr(self::OPTION_KEY); ?>[api_anbar_id]" value="<?php echo esc_attr($settings['api_anbar_id']); ?>" style="min-width: 320px;">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><label><?php esc_html_e('darookhaneID:', 'mahamsoft-order-edit'); ?></label></td>
                                        <td>
                                            <input type="number" name="<?php echo esc_attr(self::OPTION_KEY); ?>[api_darookhaneh_id]" value="<?php echo esc_attr($settings['api_darookhaneh_id']); ?>" style="min-width: 100px;">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><label><?php esc_html_e('codeMelliDaroo پیش‌فرض (موقت):', 'mahamsoft-order-edit'); ?></label></td>
                                        <td>
                                            <input type="text" name="<?php echo esc_attr(self::OPTION_KEY); ?>[api_default_code_melli]" value="<?php echo esc_attr($settings['api_default_code_melli']); ?>" style="min-width: 200px;">
            ...
            <form method="post" action="<?php echo esc_url(admin_url('admin-post.php')); ?>" id="mahamsoft-oe-report-form">
                ...
                <div class="tablenav top">
                    <div class="alignleft actions">
                        <button type="submit" name="mahamsoft_oe_bulk_action" value="delete_selected" class="button" onclick="return confirm('<?php echo esc_js(__('آیا از حذف گزارش سفارش‌های انتخاب‌شده مطمئن هستید؟ این عملیات غیرقابل بازگشت است.', 'mahamsoft-order-edit')); ?>');">
                            <?php esc_html_e('حذف موارد انتخاب‌شده', 'mahamsoft-order-edit'); ?>
                        </button>

                        <button type="submit" name="mahamsoft_oe_bulk_action" value="delete_all" class="button button-link-delete" onclick="return confirm('<?php echo esc_js(__('آیا از حذف تمامی رکوردهای گزارش (همه سفارش‌ها) مطمئن هستید؟ این عملیات غیرقابل بازگشت است.', 'mahamsoft-order-edit')); ?>');">
                        ...
                        if (empty($rows)):
                            ...
                            foreach ($rows as $row):
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="button mahamsoft-view-order-log" data-order-id="<?php echo esc_attr($order->get_id()); ?>">
    ...
    public function ajax_get_order_edit_log_details()
    {
        ...
        <p>
            <a class="button button-secondary" target="_blank" href="<?php echo esc_url(
                add_query_arg(
                    array(
        ...
        <table class="wp-list-table widefat fixed striped mahamsoft-order-log-table">
            ...
            <tbody>
                ...
                if (empty($logs)):
                    ?>
                    <tr>
                        <td colspan="6"><?php esc_html_e('هیچ تغییری ثبت نشده است.', 'mahamsoft-order-edit'); ?></td>
                    </tr>
                    <?php
                else:
                    $row_number = 1;
                    foreach ($logs as $log):
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo esc_url($delete_url); ?>" class="button button-link-delete" onclick="return confirm('<?php echo esc_js(__('آیا از حذف این رکورد مطمئن هستید؟', 'mahamsoft-order-edit')); ?>');">
